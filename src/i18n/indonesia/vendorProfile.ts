export const vendorProfile = {
  ...
  brand: 'Merek/ Tipe',
  yom: 'Tahun Produksi',
  licenseNumber: 'Nomor Seri/ Lisensi',
  capacity: 'Kapasitas',
  condition: 'Kondisi',
  ownershipStatus: 'Status Kepemilikan',
  completedProjects: 'Proyek Selesai',
  ongoingProjects: 'Proyek Berlangsung',
  ...
  name: 'Nama',
  highestEducation: 'Tingkat Pendidikan Tertinggi',
  position: 'Posisi/ Peran',
  yearsExperience: 'Tahun Pengalaman',
  skills: 'Keahlian/ Keterampilan',
  description: 'Deskripsi',
  education: 'Pendidikan',
  certificateSkills: 'Sertifikat Keahlian/ Keterampilan',
