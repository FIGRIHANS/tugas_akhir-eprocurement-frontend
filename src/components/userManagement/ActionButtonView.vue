      ...
      <div class="dropdown-content w-auto p-4 space-y-5">
        <div class="flex flex-col space-y-2">
          ...
          >
            ...
            >
              <path
                d="M8.9999 11.7378C10.328 11.7378 11.4046 10.6612 11.4046 9.33315C11.4046 8.00508 10.328 6.92847 8.9999 6.92847C7.67183 6.92847 6.59521 8.00508 6.59521 9.33315C6.59521 10.6612 7.67183 11.7378 8.9999 11.7378Z"
                fill="#78829D"
              />
              <path
                opacity="0.3"
                d="M9 2.11084C5.00906 2.11084 0.5625 6.00896 0.5625 9.33334C0.5625 12.5058 5.00906 16.5558 9 16.5558C13.2188 16.5558 17.4375 12.683 17.4375 9.33334C17.4375 6.11021 12.9909 2.11084 9 2.11084ZM9 13.0037C8.27408 13.0037 7.56446 12.7884 6.96088 12.3851C6.3573 11.9818 5.88687 11.4086 5.60907 10.7379C5.33128 10.0672 5.25859 9.32927 5.40021 8.6173C5.54183 7.90533 5.89139 7.25134 6.4047 6.73804C6.918 6.22473 7.57199 5.87517 8.28396 5.73355C8.99593 5.59193 9.73391 5.66462 10.4046 5.94241C11.0752 6.22021 11.6485 6.69064 12.0518 7.29422C12.4551 7.8978 12.6703 8.60742 12.6703 9.33334C12.6703 10.3068 12.2836 11.2403 11.5953 11.9286C10.907 12.617 9.97343 13.0037 9 13.0037Z"
                fill="#78829D"
              />
            </svg>
            Detail User
