...
import type { KTTooltipInterface, KTTooltipConfigInterface } from './types'
import type { createPopper, PositioningStrategy, Instance, Placement } from '@popperjs/core'
import type { KTTooltipTriggerType } from './types'
