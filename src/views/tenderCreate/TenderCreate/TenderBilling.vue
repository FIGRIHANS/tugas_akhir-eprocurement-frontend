<template>
  <div v-if="form">
    <div class="border rounded-xl p-[24px]">
      ...
      <div class="border rounded-lg p-[4px] mt-[24px] mb-[24px] w-fit">
        <div class="flex gap-4" data-tabs="true">
          <a
            ...
            :class="{ active: activeTabTimeline === 'automatic' }"
            href="#"
            @click="onSetTab(true)"
          >
            Automatic Timeline
          ...
          <a
            class="btn btn-primary btn-clear"
            :class="{ active: activeTabTimeline === 'manual' }"
            href="#"
      ...
      <BillingTimeline
        v-show="activeTabTimeline === 'automatic'"
        v-model="form.automaticTimeline"
      />
      <BillingTimeline
        v-show="activeTabTimeline === 'manual'"
        v-model="form.manualTimeline"
        :isManual="true"
      />
    </div>
    <div class="my-[24px]">
