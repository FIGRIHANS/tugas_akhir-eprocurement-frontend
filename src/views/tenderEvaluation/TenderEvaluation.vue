    ...
    children: [
      {
        ...
        weight: '20%',
        description: 'Kualitas produk atau layanan yang diberikan, bebas dari cacat atau kesalahan.',
      ...
      },
      {
        ...
        weight: '10%',
        description: 'Seberapa cepat dan efektif vendor merespons pertanyaan, masalah, atau permintaan.',
