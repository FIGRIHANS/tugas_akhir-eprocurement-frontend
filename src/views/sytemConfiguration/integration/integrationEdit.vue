...
const submit = () => {
    const payload = {
        ...
        client: form.client ? form.client : '',
        processIntegration: form.processIntegration ? form.processIntegration : '',
        poType: form.poType ? form.poType : '',
        poDescription: form.poDescription ? form.poDescription : '',
        ...
        definition: mappingGroups.map(g => ({
            id: g.id,
            name: g.name,
            relation: g.relation,
            open: true,
    ...
    systemConfigurationStore.updateIntegration(id, payload)
