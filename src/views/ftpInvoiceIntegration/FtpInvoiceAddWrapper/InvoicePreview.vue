...
const InvoiceView = defineAsyncComponent(
  () => import('@/views/invoice/InvoiceAddWrapper/InvoicePreview/InvoiceView.vue'),
)
...
const InvoiceItemView = defineAsyncComponent(
  () => import('@/views/invoice/InvoiceAddWrapper/InvoicePreview/InvoiceItemView.vue'),
)
const AdditionalCostView = defineAsyncComponent(
  () => import('@/views/invoice/InvoiceAddWrapper/InvoicePreview/AdditionalCostView.vue'),
)
const InvoiceCalculationView = defineAsyncComponent(
  () => import('@/views/invoice/InvoiceAddWrapper/InvoicePreview/InvoiceCalculationView.vue'),
)
const GeneralDataView = defineAsyncComponent(
  () => import('@/views/invoice/InvoiceAddWrapper/InvoicePreview/GeneralDataView.vue'),
)
const BankKeyView = defineAsyncComponent(
  () => import('@/views/invoice/InvoiceAddWrapper/InvoicePreview/BankKeyView.vue'),
)
const OneTimePayment = defineAsyncComponent(
  () => import('@/views/invoice/InvoiceAddWrapper/InvoicePreview/OneTimePayment.vue'),
)
...
@use '@/views/invoice/styles/invoice-preview.scss';
</style>
