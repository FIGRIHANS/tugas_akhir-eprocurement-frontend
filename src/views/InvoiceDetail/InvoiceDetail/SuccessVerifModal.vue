    ...
    <div class="modal-content modal-center-y max-w-[500px]">
      <div class="modal-body p-[40px] flex flex-col gap-[30px] items-center">
        ...
        <div class="text-center font-inter">
          <p class="text-lg font-medium">Invoice Has Been {{ statusCode === 2 || statusCode === 4 ? 'Verified' : 'Approved' }}</p>
          <p class="text-[13px] font-normal">The invoice has been {{ statusCode === 2 || statusCode === 4 ? 'verified' : 'approved' }} successfully.</p>
        </div>
      </div>
    </div>
  </div>
