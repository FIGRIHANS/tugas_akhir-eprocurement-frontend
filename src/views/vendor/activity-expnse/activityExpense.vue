<template>
  <div>
    ...
    <div class="card rounded-lg">
      ...
      <div class="card-body">
        <div
          v-if="paginatedActivityList.length > 0"
          ...
          <table class="table align-middle text-gray-700">
            <thead>
              <tr>
                ...
                <th class="text-nowrap !border-b-teal-500 !bg-teal-100 !text-teal-500">
                  Activity Code
                </th>
                <th class="text-nowrap !border-b-teal-500 !bg-teal-100 !text-teal-500">
                  Activity Name
    ...
    <UiModal v-model="showDeleteModal" size="sm">
      ...
      <h3 class="text-center text-lg font-medium">Are you sure to delete this activity?</h3>
      ...
      <div class="flex gap-3 px-8 mb-3">
        <UiButton outline @click="showDeleteModal = false" class="flex-1"> Cancel </UiButton>
        <UiButton
          variant="danger"
          class="flex-1"
...
const paginatedActivityList = computed(() => {
  ...
  return filteredActivityList.value.slice(start, start + activityPageSize.value)
})
