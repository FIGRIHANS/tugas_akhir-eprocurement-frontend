...
const payload = ref<IBlacklistApprovalPayload>({
  BlacklistId: 0,
  ApproveStatus: 2, //remove dan reject
  ApprovalNote: 'Removed',
  ApproveById: 0,
  ApproveByName: '',
})
...
const onClose = () => {
  const idModal = document.querySelector('#modal-remove')
...
<template>
  <div class="modal" data-modal="true" id="modal-remove" data-modal-backdrop-static="true">
