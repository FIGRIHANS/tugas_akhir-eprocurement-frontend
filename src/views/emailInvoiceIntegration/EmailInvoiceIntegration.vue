<template>
  <div>
    <Breadcrumb title="Email Invoice Integration" :routes="routes" />
    <hr class="-mx-[24px] mb-[24px]" />

    <div class="border border-gray-200 rounded-xl p-[24px]">
      <div class="flex justify-between align-items-center gap-[8px]">
        <h1>Email Invoice Integration</h1>
...
const DetailVerificationModal = defineAsyncComponent(
  () => import('./EmailDetailVerificationModal.vue'),
)

const routes = ref<routeTypes[]>([
  {
    name: 'Email Invoice Integration',
    to: '/invoice/email-integration',
  },
])
...
// Custom width for Submitted Document No column in Email Invoice Integration
:deep(.list__table) {
  th:nth-child(2),
  td:nth-child(2) {
    min-width: 250px;
