  ...
  <div class="dropdown" data-dropdown="true" data-dropdown-trigger="click">
    ...
    <div class="dropdown-content w-full max-w-[305px] p-[16px]">
      ...
      <div class="flex flex-col gap-[24px] py-[16px]">
        <div class="relative">
          <label class="absolute text-xs font-normal text-gray-500 -top-[8px] left-[10px] bg-white">Tender Request ID</label>
        ...
        <div class="relative">
          <label class="absolute text-xs font-normal text-gray-500 -top-[8px] left-[10px] bg-white">Tender Status</label>
        ...
        <div class="relative">
          <label class="absolute text-xs font-normal text-gray-500 -top-[8px] left-[10px] bg-white">PR Category</label>
        ...
        <div class="relative">
          <label class="absolute text-xs font-normal text-gray-500 -top-[8px] left-[10px] bg-white">Plant</label>
