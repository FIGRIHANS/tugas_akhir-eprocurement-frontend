  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <div class="flex align-items-center gap-[4px] mt-[20px]">
        <div class="h-[15px] rounded-sm bg-orange-500" :style="{ width: `${getEarlyDays}%` }"></div>
        <div class="h-[15px] rounded-sm bg-success" :style="{ width: `${getMidDays}%` }"></div>
        <div class="h-[15px] rounded-sm bg-info" :style="{ width: `${getLateDays}%` }"></div>
      </div>
...
import type { CardGraphTypes } from '../types/tenderReportList'
