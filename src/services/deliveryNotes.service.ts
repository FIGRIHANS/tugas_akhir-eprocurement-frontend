...
// Interface untuk Detail Item dari Delivery Notes - sesuai response backend
...
// Interface untuk data Delivery Notes - sesuai dengan response backend
export interface DeliveryNotesData {
  ...
  items: DeliveryNotesItemData[] // Backend uses 'items' not 'details'
}
